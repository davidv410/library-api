...
namespace LibraryApi.Migrations
{
    ...
    [Migration("20260904003347_Book-update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryApi.Models.RentedBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LibraryApi.Models.Message", b =>
                {
                    b.HasOne("LibraryApi.Models.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LibraryApi.Models.ApplicationUser", "Sender")
                        .WithMany()
